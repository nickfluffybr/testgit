function footerRender() {
    if ((!footerLoad) && (((document.querySelector('main')?.getBoundingClientRect().bottom - document.documentElement.clientHeight) < 0) || ((document.querySelector('main')?.getBoundingClientRect().bottom + window.pageYOffset)< (document.documentElement.clientHeight)))) {
        console.log("start");
        footerLoad = true;
        setTimeout(() => {
            let html = `
            <footer class="footer">
<div class="container_menu padding">
    <div class="header_body">
        ...
        <nav class="header_menu">
            <ul class="header_list_nav">
                <li class="header_list_nav_item">
                    <a href="" class="header_list_nav_item_link current-page">Home</a>
                </li>
                <li class="header_list_nav_item">
                    <a href="" class="header_list_nav_item_link">Blog</a>
                </li>
                <li class="header_list_nav_item">
                    <a href="" class="header_list_nav_item_link">Features</a>
                </li>
                <li class="header_list_nav_item">
                    <a href="" class="header_list_nav_item_link">Pricing</a>
                </li>
                <li class="header_list_nav_item">
                    <a href="" class="header_list_nav_item_link">Documentation</a>
                </li>
            </ul>
        </nav>
        <div class="right_menu_container">
            <ul class="right_menu_container_messenger">
                <li>
                    <a href="" class="facebook">
                        <svg width="9" height="17" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="" class="right_menu_button button">
                <span>Get starte</span>
            </a>
